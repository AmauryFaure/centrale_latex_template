...
% NOMBRE DE OBJETOS
\def\nameabstract {Résumé}           % Nombre del resumen-abstract
\def\nameappendixsection {Annexes}     % Nombre de los anexos
\def\namemathcol {Corollaire}          % Nombre de los colorarios
\def\namemathdefn {Definition}        % Nombre de las definiciones
\def\namemathej {Exemple}             % Nombre de los ejemplos
\def\namemathlem {Lemme}               % Nombre de los lemas
\def\namemathobs {Observation}        % Nombre de las observaciones
\def\namemathprp {Proposition}        % Nombre de las proposiciones
\def\namemaththeorem {Théorème}        % Nombre de los teoremas
\def\nameportraitpage {Page de couverture}         % Etiqueta página de la portada
\def\namereferences {Références}     % Nombre de la sección de referencias
\def\nomchapter {Chapitres}            % Nombre de los capítulos
\def\nomltappendixsection {Annexe}     % Etiqueta sección en anexo/apéndices
\def\nomltcont {Table des matières} % Nombre del índice de contenidos
\def\nomlteqn {Table des équations}  % Nombre de la lista de ecuaciones
\def\nomltfigure {Tables des figures}  % Nombre de la lista de figuras
\def\nomltsrc {Tables des codes}     % Nombre de la lista de código
\def\nomlttable {Tables des tableaux}    % Nombre de la lista de tablas
\def\nomltwfigure {Figure}            % Etiqueta leyenda de las figuras
\def\nomltwsrc {Code}               % Etiqueta leyenda del código fuente
\def\nomltwtable {Tableau}              % Etiqueta leyenda de las tablas
