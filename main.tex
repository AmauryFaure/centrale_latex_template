...
\def\nombreuniversidad {Centrale Lille}
\def\nombrefacultad {École Centrale de Lille}
\def\departamentouniversidad {}
\def\imagendepartamento {RVB_300_Logo_ECOLE_CENTRALE}
\def\imagendepartamentoescala {0.2}
\def\localizacionuniversidad {Lille, France}
